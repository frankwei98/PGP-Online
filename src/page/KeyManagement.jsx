...
function MyKeyPair({ store, isKeyExist }) {
    if (!isKeyExist) {
        return false // Not rendering if key pair is not exist
    }
    return <div className="mykey columns">
...
function KeyManagement(props) {
    ...
    return (
        <div className="key-management">
            ...
            {isKeyExist ? (<div className="notification is-danger key-exist">
                你已经生成了密钥对，需要更换密钥吗？
                </div>)
            ...
            <MyKeyPair isKeyExist={isKeyExist} {...props} />
        </div>
    )
}
